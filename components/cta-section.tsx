...
export default function CTASection({ title, body }: CTASectionProps) {
  return (
    <section className="mx-auto my-16 w-full max-w-6xl px-4 md:px-8">
      <div className="force-light-text rounded-[2rem] border border-brand-accent/40 bg-gradient-to-r from-brand-ink via-brand-deep to-brand-ink p-8 text-center shadow-glow md:p-12">
